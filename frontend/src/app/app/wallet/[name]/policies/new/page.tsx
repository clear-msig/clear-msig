...
// Create-policy form. Covers the four condition shapes most useful
// for a multisig treasury: asset filter, recipient allow/blocklist,
// amount range, time window, velocity cap.
//
