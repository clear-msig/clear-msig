...
export default function WalletSwapPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-3 sm:gap-4">
      ...
      <section className="grid gap-3 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
...
function SwapReview({
  ...
  return (
    <section className="rounded-card border border-border-soft bg-surface-raised p-3 shadow-card-rest sm:p-4">
      ...
      <div className="mt-3 rounded-soft border border-border-soft bg-canvas p-3 lg:flex lg:items-center lg:justify-between lg:gap-5">
