...
import type {
  CreatePasskeyProgress,
  CreateVaultStage,
} from "@/lib/ikavery/clearmsig-actions";

export type Stage = "shape" | "confirm" | "creating" | "done";

export interface ThresholdShape {
  id: "solo" | "2of3" | "3of5";
  label: string;
  threshold: number;
  members: number;
...
export const SHAPES: ThresholdShape[] = [
  {
    id: "solo",
    label: "Just me",
    threshold: 1,
...
export function BlockedDisconnect() {
  return (
