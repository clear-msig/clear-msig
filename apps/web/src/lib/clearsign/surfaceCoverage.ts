...
export const CLEARSIGN_SURFACE_COVERAGE: ClearSignSurfaceCoverage[] = [
  ...
  },
  {
    ...
    notes: "New proposals use canonical ClearSign v4 documents. Existing v2/v3 proposal accounts retain readable approve/cancel compatibility; no new legacy proposal can be created.",
  },
  {
    id: "btc-send",
    label: "BTC send",
