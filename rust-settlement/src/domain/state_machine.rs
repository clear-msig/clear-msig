...
pub fn validate_transition(
    ...
    let allowed = match from {
        ...
        IntentStatus::SettlementQueued => {
            matches!(to, IntentStatus::SettlementInProgress | IntentStatus::Failed)
        }
        ...
        IntentStatus::SettlementCompleted => {
            matches!(to, IntentStatus::PayoutInProgress | IntentStatus::PayoutCompleted)
        }
    ...
    if matches!(to, IntentStatus::PayoutInProgress | IntentStatus::PayoutCompleted)
