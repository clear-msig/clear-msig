...
pub struct ExecuteTypedCrossChainEscrowReturnInstruction {
    pub wallet: Address,
    pub intent: Address,
...
impl From<ExecuteTypedCrossChainEscrowReturnInstruction> for Instruction {
    fn from(ix: ExecuteTypedCrossChainEscrowReturnInstruction) -> Instruction {
        let accounts = vec![
