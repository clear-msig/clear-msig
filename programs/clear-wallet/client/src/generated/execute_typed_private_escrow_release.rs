...
pub struct ExecuteTypedPrivateEscrowReleaseInstruction {
    pub wallet: Address,
    pub intent: Address,
...
impl From<ExecuteTypedPrivateEscrowReleaseInstruction> for Instruction {
    fn from(ix: ExecuteTypedPrivateEscrowReleaseInstruction) -> Instruction {
        let accounts = vec![
